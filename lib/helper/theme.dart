...
class AppTheme{
  static final ThemeData apptheme = ThemeData(
      ...
      accentColor: StreamboxColor.dodgetBlue,
      ...
      appBarTheme: AppBarTheme(
          ...
          iconTheme: IconThemeData(color: StreamboxColor.dodgetBlue,),
          elevation: 0,
          textTheme:  TextTheme(
            title: TextStyle(
                color: Colors.black,
      ...
      tabBarTheme: TabBarTheme(
        labelStyle: titleStyle.copyWith(color: StreamboxColor.dodgetBlue),
        unselectedLabelColor: AppColor.darkGrey,
        unselectedLabelStyle: titleStyle.copyWith(color: AppColor.darkGrey),
        labelColor: StreamboxColor.dodgetBlue,
        labelPadding: EdgeInsets.symmetric(vertical: 12),
      ),
      floatingActionButtonTheme: FloatingActionButtonThemeData(
        backgroundColor: StreamboxColor.dodgetBlue,
      ),
