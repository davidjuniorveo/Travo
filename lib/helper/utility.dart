...
String getChatTime(String date) {
  ...
  if (dur.inDays > 0) {
    msg = '${dur.inDays}\tday\tago';
    return dur.inDays == 1 ? '1\tday\tago' : DateFormat("dd MMM").format(dt);
  } else if (dur.inHours > 0) {
    msg = '${dur.inHours}\thr\tago';
  } else if (dur.inMinutes > 0) {
    msg = '${dur.inMinutes}\tmins\tago';
  } else if (dur.inSeconds > 0) {
    msg = '${dur.inSeconds}\tsecs\tago';
  } else {
    msg = 'just\tnow';
  }
  return msg;
