...
class ComposePostState extends ChangeNotifier {
  ...
  /// This method will trigger every time when user writes post description.
  ...
  ///
  /// `enableSubmitButton` is responsible to enable/disable post submit button
  ...
  ///  } ```
  /// For more detail visit:- https://github.com/TheAlphamerc/streambox/issues/28#issue-611695533
